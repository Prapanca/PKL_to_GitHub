<?php
	class TA_Models extends CI_Model{
		...
		function detailTA($nim){
			$query = $this->db->query("SELECT makalah_ta.nim, mahasiswa.name, makalah_ta.judul, dosen.nama as nama_dosen, 
											mahasiswa.angkatan, mahasiswa.foto, makalah_ta.doc, makalah_ta.pdf, makalah_ta.ppt,
		...
		function editTA($nim){
			$query = $this->db->query("SELECT makalah_ta.nim, mahasiswa.name, makalah_ta.judul, makalah_ta.doc, mahasiswa.angkatan,
		...
		function update($namaFile = null){
			...
			else if($namaFile['pdf']!=null){
				$form ['pdf']	= $namaFile['pdf'];
				
			}
			else if($namaFile['ppt']!=null){
				$form [
					'ppt']	= $namaFile['ppt'];
				
			}
			else if($namaFile['source_code']!=null){
				$form [
					'source_code']	= $namaFile['source_code'];
				
			}
			else if($namaFile['artikel_ilmiah']!=null){
				$form ['artikel_ilmiah']	= $namaFile['artikel_ilmiah'];
				
			}
			else if($namaFile['lampiran']!=null){
