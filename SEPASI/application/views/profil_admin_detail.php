							...
							<div class="panel panel-default">
								...
								<div class="panel-body col-lg-8">
									...
									<div class="form-group has-feedback">
										...
										<span class="glyphicon glyphicon-eye-close form-control-feedback" style="cursor: pointer; pointer-events:auto;"
												onclick="ko = this.parentNode;
												ko = ko.childNodes[3];
												console.log(ko)
												if($(ko).attr('type') == 'password'){
													$(ko).attr('type','text');
													$(this).removeClass('glyphicon-eye-close');
													$(this).addClass('glyphicon-eye-open');
												}else{
													$(ko).attr('type','password');
									...
									<div class="form-group">
										<div style="color:red;">
											<span>*Form Password digunakan untuk merubah password</span><br>
											<span>Jika tidak ingin merubah password, lewati atau biarkan form password tetap kosong</span>
										</div>
									</div>
								</div>
								<!-- /.panel-body -->
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					Data Profil Aktor Berhasil Dirubah <span class="glyphicon glyphicon-thumbs-up"></span>
				</div>
