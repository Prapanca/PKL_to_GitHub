...
<head>
    ...
    <title>Form Edit Data Skripsi Mahasiswa</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Form Data Skripsi Edit</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									...
									<span style="color:red">
										<strong>**Keterangan : </strong>Lewati field atau form yang tidak perlu diisi, jika data yang digunakan tetap sama.
									</span>
								</div>
								<!-- /.panel-body -->
							</div>
						...
						<div class="col-lg-6">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									...
									<div class="form-group">
										<label>Unggah File Dokumen Per BAB .zip /.rar</label><br>
										<?php echo $row->dokumen_per_bab;?>
