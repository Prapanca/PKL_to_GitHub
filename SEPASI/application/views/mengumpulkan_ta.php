...
<head>
    ...
    <title>Data Mengumpulkan Skrpsi</title>
...
<body>
    ...
    <div id="wrapper">
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
						...
						<?php } ?>
                        <li class="divider"></li>
                        <li><a href="<?php echo base_url()."/index.php/ReportTA_Controllers/".$linkKeluar;?>">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Tabel Data Skrpisi Mahasiswa</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									<?php foreach ($row as $row){?>
                                        <tr style="font-size:13px;">
                                            ...
                                            <td><?php echo $row->nama_dosen;?> <br> <?php echo $row->nip;?></td>
                                            <td><?php echo $row->jabatan;?></td>
                                            <td><?php echo $row->golongan;?></td>
											<td><?php echo $row->name;?> <br> <?php echo $row->nim;?></td>
											<td><?php echo $row->judul;?></td>
                                            <td>
												<a href="<?php echo base_url()."index.php/TA_Controllers/detailTA/". $row->nim;?>">
													<button class="btn btn-success" style="padding-top:2px; padding-bottom:2px;">
														Detail
													</button>
												</a>
											</td>
			...
			<div class="cetak" style="margin-bottom:25px;">
				<a target="_blank" href="<?php echo base_url()."index.php/ReportTA_Controllers/proses_laporan/".$semester.'/'.$thn.'/'.$next;?>">
