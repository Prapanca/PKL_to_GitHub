                        ...
                        <form method="POST" action="<?php echo base_url();?>index.php/Login/authentication">
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Input Your Username" name="username" type="text" required autofocus>
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Input Your Password" name="password" type="password" required>
                                </div>
