            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="Home"><i class="fa fa-clock-o fa-fw"></i> Aktifitas</a>
                        </li>
                        <li>
                            <a href="#" ><i class="fa fa-table fa-fw"></i> Tables<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="Tabel_TA">Tabel Makalah TA</a>
                                </li>
                                <li>
                                    <a href="Tabel_PKL">Tabel Laporan PKL</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="Form_TA">Form TA</a>
                                </li>
                                <li>
                                    <a href="Form_PKL">Form PKL</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
				...
				<div class="row">
					<form role="form">
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div class="form-group">
										<label>NIM</label>
										<input class="form-control" type="number" name="nim" placeholder="NIM Mahasiswa" required autofocus>
									</div>
									<div class="form-group">
										<label>NAMA LENGKAP</label>
										<input class="form-control" type="text" name="name" placeholder="Masukkan Nama Lengkap Mahasiswa" required>
									</div>						
									<div class="form-group">
										<label>ANGKATAN</label>
										<select class="form-control" name="angkatan">
											<option value="none"> -- Masukkan Tahun Angkatan Mahasiswa -- </option>
											<option> 2013 </option>
											<option> 2014</option>
										</select>
									</div>
						...
						<div style="text-align:center;" class="panel-body col-lg-12">
								<button type="submit" class="btn btn-default button">Submit Button</button>
